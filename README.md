# samuelcosta.cc | Engineering Logbook

## 🛠 Project Info
- **Project Name:** Portfolio Refactor 2026
- **Lead Designer/Dev:** Gemini CLI (Advanced Architecture & SEO Specialist)
- **Status:** WIP (Infinite Feed & SEO Optimization)
- **Aesthetic Direction:** Industrial Bento / Endless Stream / Modern Hackaday
...
- **Columns:** 4-Column Responsive Grid with `dense` packing.
- **Feed:** Continuous vertical flow of semantic `article` blocks.
- **SEO Strategy:** Semantic HTML5, JSON-LD Schema (Person/SoftwareEngineer).
...
"The site is a permanent engineering ledger. Every decision is documented, every tag is optimized for discovery. It is an industrial-grade portfolio."
